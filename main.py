...
class Player:
    def __init__(self,image):
        self.image = image
        self.rect = self.image.get_rect(center = (30,350))
        self.gravity = 20
        self.jump_height = 20
...
class Game:
    def __init__(self):
        ...
        self.demon = GoatDemon(self.get_image('assets\cultist.png',24,24,1,5,None))
        self.player = Player(self.get_image('assets\knight.png',24,24,0,3,None))
    ...
    def update(self):
        self.CLOCK.tick(60)
        pygame.display.flip()
        self.player.run_player_methods()
